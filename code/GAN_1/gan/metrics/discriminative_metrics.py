...
def discriminator(x, t, hidden_dim):
    ...
    with tf.compat.v1.variable_scope(
        ...
        y_hat_logit = tf.compat.v1.contrib.layers.fully_connected(
...
def discriminative_score_metrics(ori_data, generated_data):
    ...
    y_logit_real, y_pred_real, d_vars = discriminator(X, T, hidden_dim)
    y_logit_fake, y_pred_fake, _ = discriminator(X_hat, T_hat, hidden_dim)
